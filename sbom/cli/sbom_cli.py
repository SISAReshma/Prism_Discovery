...
ROOT = Path(__file__).resolve().parents[2]  # AIBOM/ directory (so 'sbom' package is importable)
if str(ROOT) not in sys.path:
    sys.path.insert(0, str(ROOT))

# Import the unified orchestrator
from sbom.src.core.orchestrator import ScanOrchestrator, ScanResult
from sbom.src.utils.file_utils import ensure_dir
from sbom.src.utils.git_utils import probe_repo_access, verify_pat
