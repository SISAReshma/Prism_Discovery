...
def get_db_connection():
    ...
    try:
        ...
        logger.error("Database connection failed", extra={"error": sanitize_sensitive(str(e))})
        return None
...
def get_pypi_from_db(package: str, version: Optional[str] = None) -> Optional[Dict]:
    ...
    try:
        ...
        logger.warning("DB cache lookup failed", extra={"cache_type": "pypi", "package": package, "error": sanitize_sensitive(str(e))})
    finally:
        if conn:
            conn.close()
...
def set_pypi_to_db(package: str, data: Dict, version: Optional[str] = None) -> bool:
    ...
    try:
        ...
        logger.warning("DB cache write failed", extra={"cache_type": "pypi", "package": package, "error": sanitize_sensitive(str(e))})
    finally:
        if conn:
            conn.close()
...
def get_npm_from_db(package: str, version: Optional[str] = None) -> Optional[Dict]:
    ...
    try:
        ...
        logger.warning("DB cache lookup failed", extra={"cache_type": "npm", "package": package, "error": sanitize_sensitive(str(e))})
    finally:
        if conn:
            conn.close()
...
def set_npm_to_db(package: str, data: Dict, version: Optional[str] = None) -> bool:
    ...
    try:
        ...
        logger.warning("DB cache write failed", extra={"cache_type": "npm", "package": package, "error": sanitize_sensitive(str(e))})
    finally:
        if conn:
            conn.close()
...
def get_depsdev_from_db(ecosystem: str, package: str, version: str) -> Optional[Dict]:
    ...
    try:
        ...
        logger.warning("DB cache lookup failed", extra={"cache_type": "depsdev", "ecosystem": ecosystem, "package": package, "error": sanitize_sensitive(str(e))})
    finally:
        if conn:
            conn.close()
...
def set_depsdev_to_db(ecosystem: str, package: str, version: str, data: Dict) -> bool:
    ...
    try:
        ...
        logger.warning("DB cache write failed", extra={"cache_type": "depsdev", "ecosystem": ecosystem, "package": package, "error": sanitize_sensitive(str(e))})
    finally:
        if conn:
            conn.close()
...
def get_osv_from_db(ecosystem: str, package: str, version: Optional[str] = None) -> Optional[List[Dict]]:
    ...
    try:
        ...
        logger.warning("DB cache lookup failed", extra={"cache_type": "osv", "ecosystem": ecosystem, "package": package, "error": sanitize_sensitive(str(e))})
    finally:
        if conn:
            conn.close()
...
def set_osv_to_db(ecosystem: str, package: str, vulns: List[Dict], version: Optional[str] = None) -> bool:
    ...
    try:
        ...
        logger.warning("DB cache write failed", extra={"cache_type": "osv", "ecosystem": ecosystem, "package": package, "error": sanitize_sensitive(str(e))})
    finally:
        if conn:
            conn.close()
