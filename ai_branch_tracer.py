...
from config import normalize_path, LANGUAGE_EXTENSIONS
        ...
        for lib in libraries:
            ...
            if not source_files:
                ...
                ai_branches[lib_name] = _create_branch_entry(
                    ...
                    set(), error="No source files found for library"
                )
                continue
...
def trace_ai_branches(
    ...
    Args:
        ...
        categorization_data: AI library categorization results
    ...
    return {
        ...
        "summary": _compute_summary(ai_branches)
    }
